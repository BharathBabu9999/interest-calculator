...
export function IntroSection() {
  return (
    ...
    >
      ...
      <h3 className="text-xl font-semibold mb-3 mt-6 dark:text-white">Real-World Example: Understanding Your Loan Balance</h3>
  ...
  return (
    <Accordion title="Frequently Asked Questions">
      <div className="space-y-4">
        ...
        <div>
          <h3 className="font-semibold text-lg mb-2 dark:text-white">What does the interest rate represent?</h3>
          <p className="text-gray-700 dark:text-slate-300">
...
export function Footer() {
  return (
    <footer className="bg-slate-800 dark:bg-slate-900/80 dark:border dark:border-slate-700/50 text-white py-8 px-6 rounded-lg mt-12">
