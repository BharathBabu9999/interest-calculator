          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2 w-full lg:w-auto">
              <button
                ...
                className="inline-flex items-center px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-600 hover:text-slate-900 dark:hover:text-white transition-colors shadow-sm"
              >
            ...
            <div className="flex flex-wrap items-center justify-end gap-3 w-full lg:w-auto">
               ...
               <div className="w-px h-8 bg-slate-200 dark:bg-slate-600 hidden sm:block"></div>
